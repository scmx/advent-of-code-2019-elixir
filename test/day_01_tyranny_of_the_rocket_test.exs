defmodule Adventofcode.Day01TyrannyOfTheRocketTest do
  ...
  describe "break_down_fuel/1" do
    ...
    test "the total fuel required for a module of mass 1969 is 654 + 216 + 70 + 21 + 5 = 966" do
      assert 966 = 1969 |> calculate_fuel() |> break_down_fuel()
    end
  end
end
